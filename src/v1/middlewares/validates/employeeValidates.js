...
const validateCreateEmployee = [
   ...
   body("employee_gender").optional().isIn([-1, 0, 1]).withMessage("Giới tính không hợp lệ"),

   body("office_id").optional().isInt().withMessage("ID văn phòng phải là số"),

   body("employee_type_id").optional().isInt().withMessage("ID loại nhân viên phải là số"),
];
...
const validateUpdateEmployee = [
   ...
   body("employee_full_name").optional().isLength({min: 2, max: 500}).withMessage("Họ tên phải từ 2-500 ký tự"),
   ...
   body("employee_username").optional().isLength({min: 3, max: 255}).withMessage("Tên đăng nhập phải từ 3-255 ký tự"),
   ...
   body("employee_password").optional().isLength({min: 6}).withMessage("Mật khẩu phải có ít nhất 6 ký tự"),
   ...
   body("is_locked").optional().isIn([0, 1]).withMessage("Trạng thái khóa không hợp lệ"),
];
